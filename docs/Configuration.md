...
Without specific configuration, StackExchange.Redis will use the ConfigurationOptions.LoggerFactory protocol; this means that pub/sub requires a separate connection to the server. RESP3 is a newer protocol
